    ...
    <div class="brand-detail" id="brand-detail">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div v-for="(item,i) in detailInfo.image" class="swiper-slide" :key="'-' + i" v-bind:style="{backgroundImage: 'url(' + uploadUrl + item.imageName + ')'}"></div>
            </div>
  ...
  .brand-detail .about {
    ...
    .brand-detail .about .about-header {
      ...
      .brand-detail .about .about-header:after {
        ...
        width: 100%;
        height: 0.01333rem;
        background: linear-gradient(top right, #1f1d1d, #fff, #1f1d1d);
        background: -webkit-linear-gradient(top right, #1f1d1d, #fff, #1f1d1d); }
