    ...
    <div id="chose-address">
        <div class="chose-list" v-for="(item,index) in addressList" :key="index">
            ...
            <div class="chose">
                ...
                <div class="write" @click="writeAddress(item)">
                    <p>编辑</p>
                </div>
...
<script>
    ...
    //			token : '100001-FBiQx4XqwuVG3IsceyhQcir5jCbOryAW',
                payUrl : ''
            }
        },
        methods: {
            async defAddress(index){
                ...
                this.addressList[index].status = (this.addressList[index].status == '1') ? '0' : '1';
            },
            writeAddress(item){
                this.$router.push('/addAddress');
    			storage.session('addressLists',item);
            },
            ...
            async deleteAddress(item,index){
                ...
                storage.session('addressList',self.addressList);
            },
            toPageAddress(){
                this.$router.push('/addAddress');
            },
            ...
            async getPayUrl(){
                let payUrl = storage.session('payUrl');
    			if(payUrl){
    				this.payUrl = payUrl; 
    			}else{
