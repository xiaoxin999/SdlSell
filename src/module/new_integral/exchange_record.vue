            ...
            <div class="content">
                <div v-for = "(c,index) in list" :key="index">
                    ...
                    <div class="left" @click="getExchangeQR(c)">
                        <div class="goods">商品：{{c.gname}}</div>
                        <div>消耗：{{c.price}}积分</div>
...
<script>
    ...
    export default {
                ...
                if(levelId == null && utils.isEmptyObject(levelList)) {
                    ...
                    for(var i = 0; i < levelList.length; i++) {
                        ...
                        if(levelList[i].id == levelId) {
                            amount = this.info.member.totalCharge;
                        ...
                        if(nextLevelId == levelList[i].id) {
                            ...
                            this.nextNeedPrice = Number(levelList[i].totalCharge - amount).toFixed(2);
                        }
                    }
                }
            },
        ...
        mounted(){
            ...
            this.info = info;
            this.point = Number(info.point).toFixed(2);
