<template>
    <div class="pay-list" style="height: auto;">
        <div class="pay-goods">
            ...
            <div class="initialPrice" :class="isMember && packages.isVip != '0' ? 'goodsDiscount' : ''">￥{{packages.price}}</div>
            <div class="vipPrice" v-if="isMember && packages.isVip == '1'">￥{{packages.vipPrice}}</div>
            <div class="vipPrice" v-if="isMember && packages.isVip == '2'">￥{{getVipDiscount(packages.price)}}</div>
        </div>
